...
import com.rreynoud.response.Response;
...
public class UserController {
	...
	private ResponseEntity<Response<User>> create(HttpServletRequest request, @RequestBody User user,
		...
		try {
			...
			User userRegistered = (User) userService.createOrUpdate(user);
	...
	public ResponseEntity<Response<User>> update(HttpServletRequest request, @RequestBody User user,
		...
		try {
			...
			User userRegistered = userService.createOrUpdate(user);
			response.setData(userRegistered);
	...
	// @PostMapping
	// @PreAuthorize("hasAnyRole('ADMIN')")
	// public ResponseEntity<?> createUser(HttpServletRequest request, @RequestBody
	// User user) {
	// User u = this.userService.createOrUpdate(user);
